...
<body>
    ...
    if(isset($_SESSION["password"]) && isset($_SESSION["username"]) && !isset($_GET["submit"])){
        echo"<div class='col-sm-12>'";
        echo'<div class="container">';
        echo'<form action="order.php?submit=true" method="post">';
    ...
    if(isset($_SESSION["password"]) && isset($_SESSION["username"]) && isset($_GET["opslaan_submit"])){
        ...
        $sql = "INSERT INTO rooster (voornaam, achternaam, tijd, vak, email,) VALUES ('$sqlFirstname', '$sqlLastname', '$sqlEmail', '$sqlplanList', '$sqlTime')";
        $conn->query($sql);
